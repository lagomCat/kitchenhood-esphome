...
- Управление вытяжкой из Home Assistant (Переключатели: Подсветка, Звук нажатия кнопок, Скорость мотора 0, Скорость мотора 1, Скорость мотора 2, Скорость мотора)
