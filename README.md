...
На данный момент есть положительный пример автоматизации включения и выключения вытяжки по датчику влажности. В качестве датчика используется бывший более 10 лет в эксплуатации SHT21. Датчик расположен за жировым фильтром внутри корпуса вытяжки. Автоматизация включения настроена в Home Assistant по скорости нарастания влажности. В моём случае установлен порог 2.5% за 15 секунд. Поддержка рабочего режима и автоматическое выключение - по дополнительному устройству в Home Assistant (Статистика - Стандартное отклонение), т.е. по колебаниям влажности. Если колебания влажности снижаются ниже 0.2%, вытяжка выключается. 
